      ...
      <div className="row g-4">
        <div className="col-lg-5">
          ...
          <div className="socials">
            <a data-whatsapp-link="primary" href="#" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Support"><i className="bi bi-whatsapp"></i></a>
          ...
          <div className="mt-3">
            ...
            >
              ...
              <span>Direct WhatsApp Enquiry: <strong data-support-phone>+91 8113001959</strong></span>
            </a>
          </div>
        </div>
        ...
        <div className="col-6 col-lg-2">
          ...
          <a data-whatsapp-link="support" href="#" target="_blank" rel="noopener noreferrer">Enquiry Support</a>
        </div>
