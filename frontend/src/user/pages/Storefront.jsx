...
export default function Storefront() {
  ...
  {/*  ANNOUNCE POPUP (dismissible snackbar)  */}
  ...
  {/*  MOBILE DRAWER (left-push, full height)  */}
  ...
  <main id="home">
    ...
    <section className="hero" id="heroSection">
      <div className="hero-scroll-space">
        {/*  invisible snap markers: scroll 1 rests on stage 2, scroll 2 on stage 3, scroll 3 exits  */}
        ...
        <div className="hero-sticky">
          ...
          {/*  All stages share this single wrapper  */}
            ...
            <div className="container">
              <div className="hero-stages-inner">
                ...
                <div className="hero-stage active" data-stage="0">
                  ...
                  <p className="hero-sub">A high-performance exterior system for deep cleaning, rich foam and a mirror-gloss
                    finish. Scroll — the model does the talking.</p>
                  ...
                  <div className="hero-meta">
                    <div className="meta-item">
                      <div className="meta-stars">★★★★★</div><span>4.9 rating</span>
                    </div>
                    <div className="meta-divider"></div>
                    <div className="meta-item"><i className="bi bi-people"></i><span>2,300+ washes</span></div>
                    <div className="meta-divider"></div>
                    <div className="meta-item"><i className="bi bi-truck"></i><span>Free ship <span
                          id="heroShipNote">₹999</span>+</span></div>
                  </div>
                </div>
                ...
                <div className="hero-stage" data-stage="1">
                  ...
                  <p className="hero-sub">Clean+ Foam Wash lays down a thick, paint-safe blanket that lifts grit away before
                    your mitt touches the surface.</p>
                  <div className="hero-actions">
                ...
                <div className="hero-stage stage-center" data-stage="2">
                  ...
                  <p className="hero-sub">Dry with premium microfiber, step back and admire. Your entire routine, one shelf.
                  </p>
                  <div className="hero-actions">
              ...
              </div>{/*  /.hero-stages-inner  */}
            </div>{/*  /.container  */}
          </div>{/*  /.hero-stages-wrap  */}
    ...
    {/*  MARQUEE — two identical groups = seamless infinite roll  */}
      ...
      <div className="container">
        <div className="bundle-card reveal">
          <div className="bundle-copy">
            ...
            <p className="bundle-desc">One focused setup for your weekend detail. Foam, tools and premium microfiber
              essentials in one kit.</p>
    ...
    <section className="sec process-sec" id="how-it-works">
      <div className="container">
        <div className="text-center reveal">
          ...
          <p className="sec-sub mx-auto" style={{"maxWidth":"480px"}}>No complicated detailing setup. Just the right product at
            the right moment.</p>
        </div>
      ...
      <div className="container">
        <div className="interior-card reveal">
          <div className="interior-copy">
            ...
            <p className="interior-desc">Dedicated interior products for dashboards, fabrics, glass and cabin mess. Exterior
              first. Interior next.</p>
            <button className="btn-outline-lime" id="notifyBtn">Get notified <i className="bi bi-bell"></i></button>
          </div>
          <div className="interior-art">
            <img className="art-photo" src="assets/interior-teaser.png"
              alt="Premium vehicle interior bathed in lime accent light" loading="lazy" />
        ...
        <div className="row g-3">
          <div className="col-md-4 reveal">
            <article className="review-card">
              ...
              <p>"The foam is the fun part. The vehicle looks noticeably cleaner without making the routine
                complicated."</p>
          ...
          <div className="col-md-4 reveal">
            <article className="review-card review-hero">
              <div className="rev-stars">★★★★★</div>
              <p>"Everything feels like it belongs together. The sprayer, towel and wash make a great starter setup."
              </p>
          ...
          <div className="col-lg-8 reveal">
            <div className="accordion neat-acc" id="faqAccordion">
              <div className="accordion-item">
                <h3 className="accordion-header"><button className="accordion-button" data-bs-toggle="collapse"
                    data-bs-target="#faq1">What is the Neatify Clean+ Foam Wash for?</button></h3>
                <div id="faq1" className="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                  <div className="accordion-body">An exterior vehicle wash shampoo that creates rich foam to lift grit and
                    support a clean, glossy wash routine.</div>
                </div>
              </div>
              <div className="accordion-item">
                <h3 className="accordion-header"><button className="accordion-button collapsed" data-bs-toggle="collapse"
                    data-bs-target="#faq2">Can I use the pressure foam sprayer without a pressure washer?</button></h3>
                <div id="faq2" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                  <div className="accordion-body">Yes. It's a manual pressure foam sprayer — fill, pressurize and use the
                    adjustable nozzle to apply foam.</div>
                </div>
              </div>
              <div className="accordion-item">
                <h3 className="accordion-header"><button className="accordion-button collapsed" data-bs-toggle="collapse"
                    data-bs-target="#faq3">Is the interior range available now?</button></h3>
                <div id="faq3" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                  <div className="accordion-body">Not yet. Interior care is an upcoming range — the current storefront
                    focuses on exterior cleaning.</div>
                </div>
              </div>
              <div className="accordion-item">
                <h3 className="accordion-header"><button className="accordion-button collapsed" data-bs-toggle="collapse"
                    data-bs-target="#faq4">Can I buy a complete cleaning setup?</button></h3>
                <div id="faq4" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                  <div className="accordion-body">Yes. Use the Weekend Kit or add individual products to build your own
                    exterior-care setup.</div>
                </div>
              </div>
              <div className="accordion-item">
                <h3 className="accordion-header"><button className="accordion-button collapsed" data-bs-toggle="collapse"
                    data-bs-target="#faq5">Do you offer free shipping?</button></h3>
                <div id="faq5" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                  <div className="accordion-body">Free shipping on orders above <span id="faqShipThreshold">₹999</span>.
                    Standard delivery 3–5 business days across India.</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <div className="modal fade" id="productModal" tabindex="-1" aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-lg">
      <div className="modal-content prod-modal">
        <button type="button" className="modal-x" data-bs-dismiss="modal" aria-label="Close"><i
  ...
  {/*  AUTH MODAL — sign in / create account (checkout requires one)  */}
    ...
    <div className="modal-dialog modal-dialog-centered modal-sm">
      <div className="modal-content auth-modal">
        ...
        <div className="auth-head">
          ...
          <p id="authNotice" className="auth-notice d-none"><i className="bi bi-shield-lock"></i> Sign in to complete your
            purchase.</p>
        </div>
        ...
        <form id="loginForm" novalidate>
          <label>Email<input type="email" id="liEmail" placeholder="you@example.com" autocomplete="email"
              required /></label>
          <label>Password<span className="pw-wrap"><input type="password" id="liPassword" placeholder="••••••••"
                autocomplete="current-password" required /><button type="button" className="pw-eye" data-eye="liPassword"
                aria-label="Show password"><i className="bi bi-eye"></i></button></span></label>
          <button className="btn-lime w-100" type="submit" id="loginBtn">Sign in <i
              className="bi bi-box-arrow-in-right"></i></button>
        </form>
        <form id="registerForm" className="d-none" novalidate>
          ...
          <label>Email<input type="email" id="rgEmail" placeholder="you@example.com" autocomplete="email"
              required /></label>
          <label>Password<span className="pw-wrap"><input type="password" id="rgPassword" placeholder="Min. 6 characters"
                autocomplete="new-password" required /><button type="button" className="pw-eye" data-eye="rgPassword"
                aria-label="Show password"><i className="bi bi-eye"></i></button></span></label>
          <button className="btn-lime w-100" type="submit" id="registerBtn">Create account <i
  ...
  {/*  ACCOUNT MODAL — profile / orders / security  */}
        ...
        <div className="row g-0">
          <div className="col-md-4 acc-side">
            ...
            <div className="acc-tabs" role="tablist">
              <button className="acc-tab active" data-acc="orders" type="button"><i className="bi bi-box-seam"></i>
                Orders</button>
            ...
            <button className="acc-logout" id="logoutBtn" type="button"><i className="bi bi-box-arrow-right"></i> Sign
              out</button>
          </div>
          <div className="col-md-8 acc-main">
            ...
            <div className="acc-pane" id="accPaneProfile">
              ...
              <form id="profileForm" novalidate>
                ...
                <label>Default address<textarea id="pfAddress" rows="3" placeholder="House, street, city, PIN"
                    autocomplete="street-address"></textarea></label>
                <button className="btn-lime" type="submit" id="profileSaveBtn">Save changes <i
                    className="bi bi-check2"></i></button>
              </form>
            </div>
            <div className="acc-pane" id="accPaneSecurity">
              ...
              <form id="passwordForm" novalidate>
                ...
                <label>New password<input type="password" id="pwNext" placeholder="Min. 6 characters"
                    autocomplete="new-password" /></label>
                <button className="btn-lime" type="submit" id="passwordSaveBtn">Update password <i
                    className="bi bi-key"></i></button>
      ...
      <div className="modal-content checkout-modal">
        ...
        <div className="row g-0">
          <div className="col-md-7 co-form-side">
            ...
            <form id="checkoutForm" novalidate>
              <div className="field-row">
                <label>Full name<input type="text" id="coName" placeholder="Your name" required
                    autocomplete="name" /><small className="ferr" id="coNameError"></small></label>
                <label>Phone<input type="tel" id="coPhone" placeholder="+91 98765 43210" required
                    autocomplete="tel" /><small className="ferr" id="coPhoneError"></small></label>
              </div>
              <label>Email<input type="email" id="coEmail" placeholder="you@example.com" required
                  autocomplete="email" /><small className="ferr" id="coEmailError"></small></label>
              <label>Delivery address<textarea id="coAddress" rows="3" placeholder="House, street, city, PIN" required
                  autocomplete="street-address"></textarea><small className="ferr" id="coAddressError"></small></label>
              <label>Order notes <span className="opt">(optional)</span><textarea id="coNotes" rows="2"
                  placeholder="Anything we should know?"></textarea></label>
            </form>
          </div>
          <div className="col-md-5 co-summary-side">
            ...
            <button className="btn-lime w-100" id="placeOrderBtn" form="checkoutForm" type="submit">Place order <i
                className="bi bi-check2-circle"></i></button>
